...
def suma_cubo_pares_sum_gen(numeros: Iterable[int]) -> int:
    ...
    """
    pass # Completar
    func_gen = sum(i ** 3 for i in numeros if i % 2 == 0)
    return func_gen
...
lista = numeros_al_cubo_pares
suma_numeros_al_cubo_pares = lambda lista: sum(lista)
...
assert suma_numeros_al_cubo_pares(lista) == 288
